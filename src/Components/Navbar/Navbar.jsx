  ...
  return (
    ...
    <img  src={logo} alt="" className='logo' />
      ...
      <ul className={hideMenu ? '' :'mobile'}>
        ...
        <li><Link to='program' smooth={true} offset={-260} duration={500}>Events Page</Link></li>
        <li><Link to='about' smooth={true} offset={-150} duration={500}>About Us</Link></li>
        <li><Link to='campus' smooth={true} offset={-260} duration={500}>Gallery</Link></li>
        <li><Link to='testimonials' smooth={true} offset={-260} duration={500}>Membership</Link></li>        
